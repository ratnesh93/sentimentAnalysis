	...
	// JDBC driver name and database URL
		...
		public static void main(String[] args) throws ClassNotFoundException, SQLException, IOException {
			...
			while (rs.next()) {
				...
				//String input =  fileToPath("C:/Users/ratnesh/Documents/GitHub/sentimentAnalysis/src/featureSetProductWise/input" + productId + ".txt");  // the database
				String output = "C:/Users/ratnesh/Documents/GitHub/sentimentAnalysis/src/featureSetProductWise/output" + productId + ".txt";  // the path for saving the frequent itemsets found
				String input = "C:/Users/ratnesh/Documents/GitHub/sentimentAnalysis/src/featureSetProductWise/input" + productId + ".txt";
				double minsup = 0.01; //MINIMUM SUPPORT which the paper has used i.e. 1%
